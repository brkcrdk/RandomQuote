...
render(){
    return(
        <div id="quote-box">
            <div id="wrapper">
                <h1 id="text" className="quote-text"><span id="byk">"</span>{this.state.text}</h1>
                <p id="author" className="quote-author">- {this.state.author}</p>
                    <div className="buttons">
                        <a id="tweet-quote" className="button" href="twitter.com/intent/tweet"><i class="fab fa-twitter"></i></a>
                        <a id="tumblr-quote" className="button" href="tumblr.com/"><i class="fab fa-tumblr"></i></a>
                        <button className="button" id="new-quote" onClick={this.handleClick}>New quote</button> 
                    </div>
                <div class="footer"> by <a href="https://codepen.io/brkcrdk/">dasburak</a></div>
            </div>
        </div>
    )
}
